...
<head>
<meta charset="utf-8" />
<title>Metronic | The Ultimate Multi-purpose Bootstrap Admin Dashboard Theme | Theme #3 | User Login 1</title>
...
<body class=" login">
  <!-- BEGIN LOGO -->
  <div class="logo">
    <a href="index.html"> <img src="../assets/pages/img/logo-big.png" alt="" />
    </a>
  </div>
  <!-- END LOGO -->
  <!-- BEGIN LOGIN -->
  ...
  <script src="${context_root }/static/framework/metronic/v4.7/theme/assets/pages/scripts/login.min.js" type="text/javascript"></script>
